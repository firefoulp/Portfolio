  ...
  def next_message(self, yes_or_no):
    if yes_or_no == "yes":
      if self.first_node != None:
        self.current_conversation_node = self.first_node.yes_node.message
        print(self.current_conversation_node)
    else:
      if self.first_node != None:
        self.current_conversation_node = self.first_node.no_node.message
        print(self.current_conversation_node)
